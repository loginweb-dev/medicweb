...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" data-toggle="modal" data-target="#modal-laboratorios" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-laptop-medical fa-sm text-white-50"></i> Ver lista de laboratorios</a>
</div>
...
<div class="modal fade" id="modal-laboratorios" tabindex="-1" role="dialog" aria-labelledby="ratingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ratingModalLabel">Laboratorios con los que trabajamos</h5>
            ...
            <div class="modal-body">
                <table class="table table-bordered dataTable">
                    ...
                    <tbody>
                        @foreach (App\Contact::where('deleted_at', NULL)->where('type', 'Laboratorio')->get() as $item)
                            <tr>
